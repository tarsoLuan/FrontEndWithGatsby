...
export default function Profile({}) {
    ...
    useEffect(() => {
        ...
        axios.get('http://192.168.0.104:8080/api/review/last', {params: {id: user.id, limit: 3}}).then(response => {
        ...
        axios.get('http://192.168.0.104:8080/api/review/lastNotNull', {params: {id: user.id, limit: 4}}).then(response => {
