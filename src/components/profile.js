...
export default function Profile({}) {
    ...
    useEffect(() => {
        ...
        axios.get('https://monoserver.arduine.cloud/api/review/last', {params: {id: user.id, limit: 3}}).then(response => {
        ...
        axios.get('https://monoserver.arduine.cloud/api/review/lastNotNull', {params: {id: user.id, limit: 4}}).then(response => {
