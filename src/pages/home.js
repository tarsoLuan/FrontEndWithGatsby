...
const IndexPage = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://monoserver.tarso.cloud/api/review/last', {params: {id: user.id, limit: 5}}).then(response => {
      ...
      axios.get('https://monoserver.tarso.cloud/api/review/lastNotNull', {params: {id: user.id, limit: 1}}).then(response => {
