...
const IndexPage = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://192.168.0.104:8080/api/review/last', {params: {id: user.id, limit: 5}}).then(response => {
      ...
      axios.get('https://192.168.0.104:8080/api/review/lastNotNull', {params: {id: user.id, limit: 1}}).then(response => {
